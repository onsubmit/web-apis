...
<Tabs>
  <TabItem label="Sender" icon="rss">
    <Playground client:only="react" theme="dark" script={Sender} />
  </TabItem>
  <TabItem label="Receiver 1">
    <Playground client:only="react" theme="dark" script={Receiver1} />
  </TabItem>
  <TabItem label="Receiver 2">
    <Playground client:only="react" theme="dark" script={Receiver2} />
  </TabItem>
</Tabs>
